...
const tutorials = [
  ...
  },
  {
    ...
    description:
      "Run the local asset watcher and Shopify theme preview together so SCSS and theme changes update while coding.",
    lessons: 7,
    time: "55m",
    level: "Intermediate",
    image:
...
const buildToolsSteps = [
  {
    ...
    label: "Folder",
    description: "Start in the actual theme project folder so npm, Gulp, and Shopify CLI can find the right files.",
    imageTitle: "Theme project folder",
    imageHint: "Placeholder: add a screenshot of the project root in VS Code.",
    nav: "Folder",
    action: "Open VS Code terminal docs",
    url: "https://code.visualstudio.com/docs/terminal/basics",
    tryTasks: ["Open the theme folder in VS Code.", "Open Terminal > New Terminal.", "Confirm package.json is visible if the project uses npm."],
    example: "Example: the terminal should be inside the folder that contains package.json and theme folders.",
    mistake: "Do not run build commands from Downloads, Desktop, or the wrong parent folder.",
  ...
  },
  {
    ...
    label: "npm install",
    description: "Run npm install when the project has package.json and dependencies are not installed yet.",
    imageTitle: "npm install",
    imageHint: "Placeholder: add a screenshot of npm install output.",
    nav: "Install",
    action: "Open npm install docs",
    url: "https://docs.npmjs.com/cli/commands/npm-install",
    tryTasks: ["Find package.json.", "Run npm install.", "Wait until the install finishes before running watchers."],
    example: "Example command: npm install",
    mistake: "Do not run npm install in a folder without package.json.",
  ...
  },
  {
    ...
    label: "Gulp watch",
    description: "gulp watch keeps watching source files and compiles assets like SCSS or JavaScript when the project uses Gulp.",
    imageTitle: "gulp watch terminal",
    imageHint: "Placeholder: add a screenshot of gulp watch running.",
    nav: "gulp watch",
    action: "Open Gulp docs",
    url: "https://gulpjs.com/docs/en/getting-started/quick-start/",
    tryTasks: ["Run gulp watch.", "Keep the terminal open.", "Do not close it while editing SCSS or JS."],
    example: "Example command: gulp watch",
    mistake: "Do not use gulp watch unless the project actually includes a Gulp setup.",
  ...
  },
  {
    ...
    label: "Two terminals",
    description: "Use one terminal for Gulp and another terminal for Shopify CLI so both processes can run at the same time.",
    imageTitle: "Two terminals",
    imageHint: "Placeholder: add a screenshot of split terminals.",
    nav: "Second terminal",
    action: "Open VS Code terminal docs",
    url: "https://code.visualstudio.com/docs/terminal/basics",
    tryTasks: ["Leave gulp watch running.", "Open a second terminal.", "Confirm the second terminal is also in the project folder."],
    example: "Example: terminal one runs gulp watch, terminal two runs shopify theme dev.",
    mistake: "Do not stop gulp watch just to run Shopify CLI if both are needed.",
  ...
  },
  {
    ...
    label: "theme dev",
    description: "Run Shopify CLI in the second terminal to preview the theme against the assigned store.",
    imageTitle: "shopify theme dev",
    imageHint: "Placeholder: add a screenshot of shopify theme dev output.",
    nav: "theme dev",
    action: "Open Shopify theme dev docs",
    url: "https://shopify.dev/docs/api/shopify-cli/theme/theme-dev",
    tryTasks: ["Run shopify theme dev --store sample-store.myshopify.com.", "Log in if prompted.", "Open the preview link."],
    example: "Correct command: shopify theme dev --store sample-store.myshopify.com",
    mistake: "Do not write --store:sample-store.shopify.com. Use a space after --store.",
  ...
  },
  {
    ...
    label: "Edit",
    description: "While coding, keep the asset watcher and Shopify preview running so changes compile and preview correctly.",
    imageTitle: "Live coding workflow",
    imageHint: "Placeholder: add a screenshot of VS Code plus two terminals.",
    nav: "Keep running",
    action: "Open Shopify CLI docs",
    url: SHOPIFY_THEME_CLI_DOCS_URL,
    tryTasks: ["Edit one SCSS or theme file.", "Watch the Gulp terminal for compile output.", "Refresh or check the Shopify preview."],
    example: "Example: SCSS changes compile through Gulp, then Shopify preview shows the updated theme.",
    mistake: "Do not assume Shopify preview is broken if Gulp stopped compiling.",
  ...
  },
  {
    ...
    label: "Stop",
    description: "Stop long-running terminal processes with Ctrl + C when the work session is finished.",
    imageTitle: "Stop terminal process",
    imageHint: "Placeholder: add a screenshot of stopping a terminal process.",
    nav: "Stop",
    action: "Open VS Code terminal docs",
    url: "https://code.visualstudio.com/docs/terminal/basics",
    tryTasks: ["Click the terminal running gulp watch.", "Press Ctrl + C.", "Repeat for shopify theme dev if needed."],
    example: "Example: Ctrl + C stops gulp watch or shopify theme dev.",
    mistake: "Do not close VS Code without understanding which processes were running.",
...
const bemBasicSteps = [
  {
    ...
    label: "Block",
    description: "A block is a standalone component that can make sense by itself, like card, button, product-card, or site-header.",
    imageTitle: "BEM block",
    imageHint: "Placeholder: add a screenshot or diagram of one UI block.",
    nav: "Block",
    action: "Open BEM naming docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Choose one component.", "Name the block.", "Check that the name is reusable and not tied to placement."],
  ...
  },
  {
    title: "Name elements",
    label: "Element",
    description: "An element is a part of a block that depends on the block for meaning.",
    imageTitle: "BEM element",
    imageHint: "Placeholder: add a screenshot showing product-card__image and product-card__title.",
    nav: "Element",
    action: "Open BEM naming docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["List the component parts.", "Name each part as block__element.", "Keep names clear and short."],
  ...
  },
  {
    ...
    label: "Modifier",
    description: "A modifier is a variation of a block or element, such as featured, compact, disabled, or active.",
    imageTitle: "BEM modifier",
    imageHint: "Placeholder: add a screenshot showing a featured card variation.",
    nav: "Modifier",
    action: "Open BEM naming docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Choose one variation.", "Name a block modifier.", "Name one element modifier."],
  ...
  },
  {
    ...
    label: "HTML",
    description: "Use the base class plus modifier class when a component has a variation.",
    imageTitle: "BEM HTML",
    imageHint: "Placeholder: add a screenshot of HTML with BEM classes.",
    nav: "HTML",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Write a block class.", "Add element classes.", "Add a modifier class while keeping the base class."],
  ...
  },
  {
    ...
    label: "Specificity",
    description: "BEM works best with simple class selectors, not IDs, deep descendant chains, or tag-heavy selectors.",
    imageTitle: "Clean selectors",
    imageHint: "Placeholder: add a before/after selector screenshot.",
    nav: "Specificity",
    action: "Open BEM naming docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Find one deep selector.", "Replace it with a direct BEM class.", "Avoid IDs for component styling."],
  ...
  },
  {
    ...
    label: "Practice",
    description: "Practice by converting vague names into a small BEM naming map.",
    imageTitle: "BEM rename practice",
    imageHint: "Placeholder: add a screenshot of class rename examples.",
    nav: "Practice",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Rename card-img.", "Rename big-green-title.", "Rename active-price."],
...
const bemMediumSteps = [
  {
    ...
    label: "Map",
    description: "Before coding, map the component into a block, elements, and possible modifiers.",
    imageTitle: "Product card map",
    imageHint: "Placeholder: add a product card naming map.",
    nav: "Map",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Choose product-card as the block.", "List image, body, title, price, action.", "Add featured or compact as modifiers."],
  ...
  },
  {
    ...
    label: "Block mod",
    description: "A block modifier changes the whole component variation.",
    imageTitle: "Block modifier",
    imageHint: "Placeholder: add a compact/featured component screenshot.",
    nav: "Block modifier",
    action: "Open BEM modifier docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Add product-card--featured.", "Add product-card--compact.", "Explain what each changes."],
  ...
  },
  {
    ...
    label: "Element mod",
    description: "An element modifier changes only one element variation inside the block.",
    imageTitle: "Element modifier",
    imageHint: "Placeholder: add sale price example.",
    nav: "Element modifier",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Add product-card__price.", "Add product-card__price--sale.", "Keep the base price class."],
  ...
  },
  {
    ...
    label: "State",
    description: "State classes like is-active, is-loading, or is-disabled can be useful, but keep them predictable.",
    imageTitle: "State class",
    imageHint: "Placeholder: add active state example.",
    nav: "State",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Add an active state.", "Decide if it should be BEM modifier or state class.", "Keep naming consistent in the component."],
  ...
  },
  {
    ...
    label: "New block",
    description: "If a piece can live independently in many places, it may deserve to be its own block.",
    imageTitle: "Reusable block",
    imageHint: "Placeholder: add badge or price component example.",
    nav: "New block",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Find a reusable piece.", "Decide if it should stay an element.", "Create a new block if it is independent."],
  ...
  },
  {
    ...
    label: "Review",
    description: "Review for appearance-based names, element chains, missing base classes, and unclear modifiers.",
    imageTitle: "BEM review checklist",
    imageHint: "Placeholder: add a BEM code review screenshot.",
    nav: "Review",
    action: "Open BEM naming docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Find one appearance-based name.", "Find one too-deep class name.", "Fix one missing base class."],
...
const scssBasicSteps = [
  {
    ...
    label: "SCSS",
    description: "SCSS is Sass syntax that looks like CSS, then compiles into normal CSS for the browser.",
    imageTitle: "SCSS to CSS",
    imageHint: "Placeholder: add a before/after SCSS compilation screenshot.",
    nav: "SCSS",
    action: "Open Sass docs",
    url: SASS_STYLE_RULES_DOCS_URL,
    tryTasks: ["Open an SCSS file.", "Find braces and semicolons.", "Identify the compiled CSS target if the project has one."],
  ...
  },
  {
    title: "Use variables",
    label: "Variables",
    description: "Variables store repeated values like colors, spacing, radius, and transitions.",
    imageTitle: "SCSS variables",
    imageHint: "Placeholder: add a screenshot of SCSS variables.",
    nav: "Variables",
    action: "Open Sass docs",
    url: "https://sass-lang.com/documentation/variables/",
    tryTasks: ["Create $color-primary.", "Create $space-md.", "Use them in one component."],
  ...
  },
  {
    title: "Use &__element",
    label: "&__element",
    description: "Inside a block, & represents the parent selector. &__title compiles to .block__title.",
    imageTitle: "Ampersand element",
    imageHint: "Placeholder: add a screenshot showing &__title compiling to .card__title.",
    nav: "&__element",
    action: "Open Sass selector docs",
    url: SASS_SELECTOR_DOCS_URL,
    tryTasks: ["Write .product-card { &__title { } }.", "Say the compiled selector.", "Add two more elements."],
  ...
  },
  {
    title: "Use &--modifier",
    label: "&--modifier",
    description: "Inside a block, &--featured compiles to .block--featured.",
    imageTitle: "Ampersand modifier",
    imageHint: "Placeholder: add a screenshot showing &--featured compiling to .card--featured.",
    nav: "&--modifier",
    action: "Open Sass selector docs",
    url: SASS_SELECTOR_DOCS_URL,
    tryTasks: ["Write &--featured.", "Write &--compact.", "Explain the compiled CSS."],
  ...
  },
  {
    ...
    label: "States",
    description: "Use &:hover, &:focus-visible, and &[disabled] when the state belongs to the current selector.",
    imageTitle: "SCSS state selectors",
    imageHint: "Placeholder: add a hover/focus state screenshot.",
    nav: "States",
    action: "Open Sass style rules",
    url: SASS_STYLE_RULES_DOCS_URL,
    tryTasks: ["Add &:hover.", "Add &:focus-visible.", "Explain the compiled selector."],
  ...
  },
  {
    ...
    label: "Nesting",
    description: "SCSS nesting is useful, but deep nesting creates large, fragile selectors.",
    imageTitle: "Shallow nesting",
    imageHint: "Placeholder: add shallow vs deep nesting example.",
    nav: "Nesting",
    action: "Open Sass style rules",
    url: SASS_STYLE_RULES_DOCS_URL,
    tryTasks: ["Find one deep nested selector.", "Flatten it to a BEM class.", "Limit component nesting to readable levels."],
  ...
  },
  {
    ...
    label: "Responsive",
    description: "Media queries can live inside the component block when the responsive change belongs to that component.",
    imageTitle: "Responsive SCSS",
    imageHint: "Placeholder: add a component media query screenshot.",
    nav: "Responsive",
    action: "Open Sass style rules",
    url: SASS_STYLE_RULES_DOCS_URL,
    tryTasks: ["Add a max-width media query.", "Change one block property.", "Confirm compiled CSS stays understandable."],
...
const scssProSteps = [
  {
    ...
    label: "Structure",
    description: "Organize styles into predictable folders such as tokens, base, components, utilities, and pages.",
    imageTitle: "SCSS folders",
    imageHint: "Placeholder: add a screenshot of SCSS architecture folders.",
    nav: "Structure",
    action: "Open Sass docs",
    url: "https://sass-lang.com/documentation/",
    tryTasks: ["Find the styles folder.", "Identify component partials.", "Place new CSS in the correct layer."],
  ...
  },
  {
    ...
    label: "@use",
    description: "Modern Sass recommends @use for loading modules when the project build supports it.",
    imageTitle: "Sass @use",
    imageHint: "Placeholder: add a screenshot of @use with tokens.",
    nav: "@use",
    action: "Open Sass @use docs",
    url: "https://sass-lang.com/documentation/at-rules/use/",
    tryTasks: ["Find how the project imports SCSS.", "Use the existing project pattern.", "Avoid mixing import systems casually."],
  ...
  },
  {
    ...
    label: "Mixins",
    description: "Mixins are good for repeated patterns, but bad when they hide simple one-off CSS.",
    imageTitle: "SCSS mixin",
    imageHint: "Placeholder: add a responsive mixin example.",
    nav: "Mixins",
    action: "Open Sass mixin docs",
    url: "https://sass-lang.com/documentation/at-rules/mixin/",
    tryTasks: ["Find repeated CSS.", "Create or use a mixin only if it removes real duplication.", "Keep mixin names purpose-based."],
  ...
  },
  {
    ...
    label: "Tokens",
    description: "Tokens keep color, spacing, radius, typography, and shadows consistent across components.",
    imageTitle: "Design tokens",
    imageHint: "Placeholder: add a token file screenshot.",
    nav: "Tokens",
    action: "Open Sass variables docs",
    url: "https://sass-lang.com/documentation/variables/",
    tryTasks: ["Find color tokens.", "Find spacing tokens.", "Replace a hard-coded repeated value with a token."],
  ...
  },
  {
    ...
    label: "Specificity",
    description: "Professional SCSS keeps selectors easy to override by using direct classes and avoiding deep chains.",
    imageTitle: "Specificity review",
    imageHint: "Placeholder: add a specificity before/after screenshot.",
    nav: "Specificity",
    action: "Open BEM docs",
    url: BEM_NAMING_DOCS_URL,
    tryTasks: ["Find one deep selector.", "Replace it with a BEM class.", "Avoid !important unless there is a documented reason."],
  ...
  },
  {
    ...
    label: "Output",
    description: "Always think about the CSS that SCSS produces. Clean SCSS can still compile into heavy CSS if nested badly.",
    imageTitle: "Compiled CSS output",
    imageHint: "Placeholder: add compiled CSS output screenshot.",
    nav: "Output",
    action: "Open Sass style rules",
    url: SASS_STYLE_RULES_DOCS_URL,
    tryTasks: ["Pick one SCSS block.", "Write the expected compiled selector.", "Remove nesting that creates unnecessary output."],
  ...
  },
  {
    ...
    label: "Review",
    description: "Use a consistent checklist before approving BEM and SCSS work.",
    imageTitle: "SCSS review checklist",
    imageHint: "Placeholder: add internal code review checklist screenshot.",
    nav: "Checklist",
    action: "Open Sass docs",
    url: "https://sass-lang.com/documentation/",
    tryTasks: ["Check naming.", "Check nesting depth.", "Check tokens, responsiveness, accessibility, and compiled output."],
  ...
  },
  {
    ...
    label: "Judgment",
    description: "Advanced developers do not use SCSS features just to look advanced. Use the simplest readable solution.",
    imageTitle: "Plain CSS judgment",
    imageHint: "Placeholder: add simple vs over-engineered SCSS example.",
    nav: "Judgment",
    action: "Open Sass docs",
    url: "https://sass-lang.com/documentation/",
    tryTasks: ["Find one over-abstracted rule.", "Rewrite it plainly.", "Explain why simpler code is easier to maintain."],
